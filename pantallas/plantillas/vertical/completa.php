...
WHERE programacion_salones.fecha_transmision < (SELECT CURRENT_TIMESTAMP) AND programacion_salones.id_pantalla=$id_p AND programacion_salones.fecha_fin > (SELECT CURRENT_TIMESTAMP)")){
