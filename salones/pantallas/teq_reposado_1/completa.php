...
//carga datos
      if ($result = $mysqli->query("SELECT programacion_salones.id_archivo,archivos.nombre ,eventos.nombre as 'evento',programacion_salones.nombre_salon,programacion_salones.fecha_inicio,eventos.tipo, eventos.texto 
...
WHERE programacion_salones.fecha_transmision < (SELECT CURRENT_TIMESTAMP) AND programacion_salones.id_pantalla=13 or programacion_salones.id_pantalla=14 AND programacion_salones.fecha_fin > (SELECT CURRENT_TIMESTAMP)")){
